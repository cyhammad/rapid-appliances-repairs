  ...
  return <div className="flex justify-center py-20">
      <div className="flex max-w-[80rem] flex-col gap-y-10 px-5 sm:px-7 lg:px-5 ">
        ...
        <div className="grid gap-10 sm:px-5 lg:grid-cols-2 2xl:px-0">
          <ServiceCard imageUrl={"/lg/wahing.avif"} heading={"Washing Machine Repair"} description={"Delivering top-tier, professional solutions that guarantee the optimal performance of your washing machine."} />
          ...
          <ServiceCard imageUrl={"/lg/ref.jpeg"} heading={"Refrigerator Repair"} description={"Whether it's a noisy compressor, a torn gasket, or a sealed door issue causing your refrigerator not to freeze properly."} />
          ...
          <ServiceCard imageUrl={"/lg/dsih.avif"} heading={"Dishwasher Repair"} description={"We resolve common issues such as leaks, poor cleaning and unusual noises to ensure a spotless and efficient cleaning."} />
          ...
          <ServiceCard imageUrl={"/lg/wahing.avif"} heading={"Dryer Repair"} description={"Delivering top-tier, professional solutions that guarantee the optimal performance of your Dryer."} />
        </div>
      </div>
    </div>;
};
