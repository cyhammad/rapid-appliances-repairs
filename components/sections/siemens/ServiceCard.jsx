...
const ServiceCard = ({ iconImgPath, heading, description, id }) => {
  ...
  return (
    <div className="flex max-w-[300px] flex-col gap-y-5 border border-gray-400/60 p-10 bg-gray-600/20">
      <button
      ...
      <button
        onClick={() => router.push("/service/" + id)}
        className="mt-5 w-fit text-2xl font-bold transition-all duration-300 text-yellow-400"
      >
        {heading}
      </button>
