  ...
  return (
    <div className="mt-10 ">
      <div className="flex select-none justify-center  ">
        <div className=" flex w-full gap-4 lg:gap-9 max-w-[79rem] flex-col  justify-between   md:flex-row  md:px-10  xl:px-5 ">
          <div className="flex  flex-col text-center md:w-1/2 md:items-start md:text-start">
            ...
            <span className=" mt-3 text-wrap px-5 text-justify text-sm text-lg-text sm:text-base md:px-1">
      ...
      <div className="mt-10 flex select-none justify-center ">
        <div className=" flex w-full max-w-[79rem] flex-col-reverse  justify-between pt-5  md:flex-row  md:px-10 xl:px-5  ">
          <Image
            className=" w-full shrink-0 pt-5  sm:px-5 md:w-1/2 lg:h-96  md:px-0 md:pr-8 md:pt-0  "
            src="/samsung/contactUs.jpeg"
            width={480}
            height={300}
            alt="image"
          />
