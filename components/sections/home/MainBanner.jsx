...
const MainBanner = () => {
  return (
    <div className="relative flex justify-center overflow-hidden bg-blue-200/40">
      <div className="w-full max-w-7xl px-5 py-14 md:py-20 z-10">
        <div className="flex flex-col gap-y-3 lg:max-w-[50%] xl:max-w-[550px]">
          ...
          <div className="flex flex-col gap-2 sm:flex-row z-20">
            <SamsungBannerCallButton />
            <SamsungWhatsappButton />
          </div>
        </div>
      </div>
      <div className="absolute left-5 top-44 h-28 w-28 rounded-full bg-yellow-300/70 -z-10"></div>
      <div className="absolute -right-44 top-96 h-80 w-80 rounded-full bg-blue-900/85 md:-left-44 -z-10"></div>
      <Image
        src="/home/washing-machine-repair.png"
        width={700}
        height={1000}
        alt="washing machine repair"
        className="absolute right-0 top-0 hidden xl:block z-0"
      />
    </div>
  );
};
